        ...
        <header class="header bg-white">
            <div class="container px-lg-3">
                <nav class="navbar navbar-expand-lg navbar-light py-3 px-lg-0"><a class="navbar-brand" href="index.html"><span
                            class="fw-bold text-uppercase text-dark">Refurb</span></a>
                            ...
                            @if (Auth::user())
                                ...
                                <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" id="pagesDropdown"
                                    ...
                                    <div class="dropdown-menu mt-3 shadow-sm" aria-labelledby="pagesDropdown">
                                        <a class="dropdown-item border-0 transition-link" href="index.html">My Account</a>
                                        <a class="dropdown-item border-0 transition-link" href="shop.html">Logout</a>
                                    </div>
                                </li>
                            @else
                                <li class="nav-item"><a class="nav-link" href="cart.html"> <i
